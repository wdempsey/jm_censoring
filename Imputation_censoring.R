...
mean_params <- as.vector(baseline_model$beta[,1])
...
if(args[1] == 'imp') {
	...
	rev_imp <- revival_model_imputation(Table_1, Table_2, X_1, X_2, Sigma_calc, my_model, M, mean_params, cov_params, theta, 	fixed = FALSE)
